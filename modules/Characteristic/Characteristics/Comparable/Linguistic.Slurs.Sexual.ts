...
const slurs: RegExp[] = [...new Set(require("../Configurations/Linguistic.Slurs.Sexual") as string[])].map(word => new RegExp("\\b" + word + "\\b", "i"));
...
export default class extends ComparableCharacteristic<Data, Example> {
	name = "Linguistic.Slurs.Sexual";
	description = "Usage of sexual slurs";
    weight = 4;
